<?php
define("filepath", "../files/undergraduate.JSON");
...
<head>
	<meta charset="utf-8">
	<title>Undergraduate Apply Form</title>
</head>
<body style = "background-color: #AED6F1">
<h1><p align="middle">Undergraduate Apply Form</h1></p><hr>
        <p align="middle";>
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
        	<br><br>
        	<marquee direction="right"  bgcolor="#5DADE2">
<h1><a href="#" style="color:white";>Welcome to AIUB</a></h1></marquee><br><br><br><br>
        	<fieldset>
        		<legend>Undergraduate student details:</legend>
